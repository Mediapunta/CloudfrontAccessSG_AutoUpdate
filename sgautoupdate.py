...
SECURITY_GROUP_TAG_FOR_GLOBAL_HTTP = {'Rule': 'cloudfront_g', 'AutoUpdate': 'true', 'Protocol': 'http'}
SECURITY_GROUP_TAG_FOR_REGION_HTTP = {'Rule': 'cloudfront_r', 'AutoUpdate': 'true', 'Protocol': 'http'}
